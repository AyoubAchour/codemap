...
| 036 | TS/JS symbol and impact context | done | Phase 4 / behavior consistency | [task-036-symbol-impact-context.md](task-036-symbol-impact-context.md) |
...
| 042 | Range-aware source anchors | done | Phase 4 / accuracy | [task-042-range-aware-source-anchors.md](task-042-range-aware-source-anchors.md) |
| 043 | Compact query context | done | Phase 4 / retrieval | [task-043-compact-query-context.md](task-043-compact-query-context.md) |
| 044 | Source index engine v2 | done | Phase 4 / performance | [task-044-source-index-engine-v2.md](task-044-source-index-engine-v2.md) |
...
| 081 | Release v0.10.0 | in-progress | Phase 4 / release | [task-081-release-v0.10.0.md](task-081-release-v0.10.0.md) |

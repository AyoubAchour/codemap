...
| --- | ------------------------------------- | ------ | --------------- | ---------------------------------------------------------------------------------- |
| 001 | Project setup                         | todo   | Phase 0         | [task-001-project-setup.md](task-001-project-setup.md)                             |
| 002 | Pick the M1 target codebase           | todo   | Phase 0         | [task-002-pick-m1-target.md](task-002-pick-m1-target.md)                           |

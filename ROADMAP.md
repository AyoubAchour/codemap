...
Task 067 implements the first measured optimization from that baseline:
stop-word filtered structured boosts, archive-like content demotion,
disconnected-file demotion for impact/review queries, and a weak-result floor.
